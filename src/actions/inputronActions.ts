...
import { EnhanceAPIPayloadType, SuggestAPIPayloadType, PredictTextPayloadType } from '../types';

export async function enhanceAction(payload: EnhanceAPIPayloadType) {
     const backendServer = getInptronEngineApiEndPoint();

    // const backendServer = 'https://api.inputron.com';
    ...
    try {
        const res = await fetch(endpoint, {
            ...
            headers: {
                ...
                // "x-api-key": 'b59a3e3af450b26ee3e5cc532c5b4698bcf502af4481e8226b58cdeb24ee2080',
                 "client-id": getClientId() || '',
                //"client-id": 'inputronCustomer123456-InputronStore9876-inputronSubscription123456',
